...
MyDigiTwin is a scientific endeavor led by a consortium comprised of both scientific and commercial partners within the health domain. Consequently, MyDigiTwin as a technological product has two fundamental 'embodiments' given each partner's main viewpoint: a patient-oriented user-friendly product to be integrated into [PGOs](./12.Glossary.md)' infrastructure, and a research environment where scientists can develop the back-bone of the said product, that is to say, CVD prediction models.
